...
const file_transport_internet_finalmask_header_wechat_config_proto_rawDesc = "" +
	...
	"\x06ConfigB\xaf\x01\n" +
	"3com.xray.transport.internet.finalmask.header.wechatP\x01ZDgithub.com/decardlabs/uuhappyserver/transport/internet/finalmask/header/wechat\xaa\x02/Xray.Transport.Internet.Finalmask.Header.Wechatb\x06proto3"
